...
Employee e1 = new Employee("Administration", "Иван", "Фролов", "12/12/2000", "Мужской", "qwe@test.ru", "79511234567", "Руководитель");
...
company.Departments[2].Employees?.Add(new Employee("Legal", "Ирина", "Фурьева", "Женский", "11.11.1983", "IF@test.ru", "79511234567", "Старший юрист"));
